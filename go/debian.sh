...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome CorpIDR2 Tunneling ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green} CorpIDR2® ${NC}${YELLOW}(${NC} ${green} CorpIDR2Tunnel ${NC}${YELLOW})${NC}"
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ🐳","url":"https://t.me/bijiOntaTerbangG"},{"text":"ɪɴꜱᴛᴀʟʟ🐬","url":"https://t.me/infoautosc_bot"}]]}'
